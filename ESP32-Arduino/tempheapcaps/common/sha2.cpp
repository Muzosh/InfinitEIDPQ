...
{
    uint32_t* state = (uint32_t*)heap_caps_malloc((sizeof(uint32_t)*(8)), MALLOC_CAP_DEFAULT);
    uint32_t* a = (uint32_t*)heap_caps_malloc(sizeof(uint32_t), MALLOC_CAP_DEFAULT);
    uint32_t* b = (uint32_t*)heap_caps_malloc(sizeof(uint32_t), MALLOC_CAP_DEFAULT);
    uint32_t* c = (uint32_t*)heap_caps_malloc(sizeof(uint32_t), MALLOC_CAP_DEFAULT);
    uint32_t* d = (uint32_t*)heap_caps_malloc(sizeof(uint32_t), MALLOC_CAP_DEFAULT);
    uint32_t* e = (uint32_t*)heap_caps_malloc(sizeof(uint32_t), MALLOC_CAP_DEFAULT);
    uint32_t* f = (uint32_t*)heap_caps_malloc(sizeof(uint32_t), MALLOC_CAP_DEFAULT);
    uint32_t* g = (uint32_t*)heap_caps_malloc(sizeof(uint32_t), MALLOC_CAP_DEFAULT);
    uint32_t* h = (uint32_t*)heap_caps_malloc(sizeof(uint32_t), MALLOC_CAP_DEFAULT);
    uint32_t* T1 = (uint32_t*)heap_caps_malloc(sizeof(uint32_t), MALLOC_CAP_DEFAULT);
    uint32_t* T2 = (uint32_t*)heap_caps_malloc(sizeof(uint32_t), MALLOC_CAP_DEFAULT);
...
static size_t crypto_hashblocks_sha512(uint8_t* statebytes, const uint8_t* in, size_t inlen)
{
    uint64_t* state = (uint64_t*)heap_caps_malloc((sizeof(uint64_t)*(8)), MALLOC_CAP_DEFAULT);
    uint32_t* a = (uint32_t*)heap_caps_malloc(sizeof(uint32_t), MALLOC_CAP_DEFAULT);
    uint32_t* b = (uint32_t*)heap_caps_malloc(sizeof(uint32_t), MALLOC_CAP_DEFAULT);
    uint32_t* c = (uint32_t*)heap_caps_malloc(sizeof(uint32_t), MALLOC_CAP_DEFAULT);
    uint32_t* d = (uint32_t*)heap_caps_malloc(sizeof(uint32_t), MALLOC_CAP_DEFAULT);
...
static const uint8_t iv_224[32] = {0xc1, 0x05, 0x9e, 0xd8, 0x36, 0x7c, 0xd5, 0x07, 0x30, 0x70, 0xdd,
                                   0x17, 0xf7, 0x0e, 0x59, 0x39, 0xff, 0xc0, 0x0b, 0x31, 0x68, 0x58,
                                   0x15, 0x11, 0x64, 0xf9, 0x8f, 0xa7, 0xbe, 0xfa, 0x4f, 0xa4};

static const uint8_t iv_256[32] = {0x6a, 0x09, 0xe6, 0x67, 0xbb, 0x67, 0xae, 0x85, 0x3c, 0x6e, 0xf3,
...
{
    state->ctx = (uint8_t*)malloc(PQC_SHA512CTX_BYTES);
    if (state->ctx == NULL) {
        exit(111);
    }
...
{
    uint8_t* padded = (uint8_t*)heap_caps_malloc((sizeof(uint8_t)*(128)), MALLOC_CAP_DEFAULT);
...
{
    uint8_t* tmp = (uint8_t*)heap_caps_malloc((sizeof(uint8_t)*(32)), MALLOC_CAP_DEFAULT);
...
{
    uint8_t* padded = (uint8_t*)heap_caps_malloc((sizeof(uint8_t)*(256)), MALLOC_CAP_DEFAULT);
...
{
    uint8_t* tmp = (uint8_t*)heap_caps_malloc((sizeof(uint8_t)*(64)), MALLOC_CAP_DEFAULT);
