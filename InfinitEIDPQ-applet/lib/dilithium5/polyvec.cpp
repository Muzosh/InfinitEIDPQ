...
void PQCLEAN_DILITHIUM5_CLEAN_polyvecl_uniform_eta(polyvecl* v, const uint8_t* seed, uint16_t nonce)
{
    unsigned int i;
...
void PQCLEAN_DILITHIUM5_CLEAN_polyveck_uniform_eta(polyveck* v, const uint8_t* seed, uint16_t nonce)
{
    unsigned int i;
