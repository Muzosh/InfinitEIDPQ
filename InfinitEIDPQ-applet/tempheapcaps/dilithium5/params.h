...
#define PQCLEAN_DILITHIUM5_CLEAN_CRYPTO_SECRETKEYBYTES                                             \
    (3 * SEEDBYTES + L * POLYETA_PACKEDBYTES + K * POLYETA_PACKEDBYTES + K * POLYT0_PACKEDBYTES)
#define PQCLEAN_DILITHIUM5_CLEAN_CRYPTO_BYTES                                                      \
