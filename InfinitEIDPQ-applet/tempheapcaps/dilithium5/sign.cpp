...
{
    uint8_t* seedbuf =
        (uint8_t*)heap_caps_malloc((sizeof(uint8_t) * (2 * SEEDBYTES + CRHBYTES)), MALLOC_CAP_DEFAULT);
    uint8_t* tr = (uint8_t*)heap_caps_malloc((sizeof(uint8_t) * (SEEDBYTES)), MALLOC_CAP_DEFAULT);
    const uint8_t *rho, *rhoprime, *key;
    polyvecl* mat = (polyvecl*)heap_caps_malloc((sizeof(polyvecl) * (K)), MALLOC_CAP_DEFAULT);
    polyvecl* s1 = (polyvecl*)heap_caps_malloc(sizeof(polyvecl), MALLOC_CAP_DEFAULT);
    polyvecl* s1hat = (polyvecl*)heap_caps_malloc(sizeof(polyvecl), MALLOC_CAP_DEFAULT);
    polyveck* s2 = (polyveck*)heap_caps_malloc(sizeof(polyveck), MALLOC_CAP_DEFAULT);
    polyveck* t1 = (polyveck*)heap_caps_malloc(sizeof(polyveck), MALLOC_CAP_DEFAULT);
    polyveck* t0 = (polyveck*)heap_caps_malloc(sizeof(polyveck), MALLOC_CAP_DEFAULT);
...
{
    unsigned int n;
    uint8_t* seedbuf = (uint8_t*)heap_caps_malloc(
        (sizeof(uint8_t) * (3 * SEEDBYTES + 2 * CRHBYTES)), MALLOC_CAP_DEFAULT);
    uint8_t *rho, *tr, *key, *mu, *rhoprime;
    uint16_t* nonce = (uint16_t*)heap_caps_malloc(sizeof(uint16_t), MALLOC_CAP_DEFAULT);
    *nonce = 0;
    polyvecl* mat = (polyvecl*)heap_caps_malloc((sizeof(polyvecl) * (K)), MALLOC_CAP_DEFAULT);
    polyvecl* s1 = (polyvecl*)heap_caps_malloc(sizeof(polyvecl), MALLOC_CAP_DEFAULT);
    polyvecl* y = (polyvecl*)heap_caps_malloc(sizeof(polyvecl), MALLOC_CAP_DEFAULT);
    polyvecl* z = (polyvecl*)heap_caps_malloc(sizeof(polyvecl), MALLOC_CAP_DEFAULT);
    polyveck* t0 = (polyveck*)heap_caps_malloc(sizeof(polyveck), MALLOC_CAP_DEFAULT);
    polyveck* s2 = (polyveck*)heap_caps_malloc(sizeof(polyveck), MALLOC_CAP_DEFAULT);
    polyveck* w1 = (polyveck*)heap_caps_malloc(sizeof(polyveck), MALLOC_CAP_DEFAULT);
    polyveck* w0 = (polyveck*)heap_caps_malloc(sizeof(polyveck), MALLOC_CAP_DEFAULT);
    polyveck* h = (polyveck*)heap_caps_malloc(sizeof(polyveck), MALLOC_CAP_DEFAULT);
    poly* cp = (poly*)heap_caps_malloc(sizeof(poly), MALLOC_CAP_DEFAULT);
    shake256incctx* state = (shake256incctx*)heap_caps_malloc(sizeof(shake256incctx), MALLOC_CAP_DEFAULT);
...
rej:
    ...
    *siglen = PQCLEAN_DILITHIUM5_CLEAN_CRYPTO_BYTES;
    heap_caps_free(seedbuf);
    heap_caps_free(nonce);
    heap_caps_free(mat);
    heap_caps_free(s1);
    heap_caps_free(y);
    heap_caps_free(z);
                                                ...
                                                size_t mlen, const uint8_t* pk)
{
    unsigned int i;
    uint8_t* buf =
        (uint8_t*)heap_caps_malloc((sizeof(uint8_t) * (K * POLYW1_PACKEDBYTES)), MALLOC_CAP_DEFAULT);
    uint8_t* rho = (uint8_t*)heap_caps_malloc((sizeof(uint8_t) * (SEEDBYTES)), MALLOC_CAP_DEFAULT);
    uint8_t* mu = (uint8_t*)heap_caps_malloc((sizeof(uint8_t) * (CRHBYTES)), MALLOC_CAP_DEFAULT);
    uint8_t* c = (uint8_t*)heap_caps_malloc((sizeof(uint8_t) * (SEEDBYTES)), MALLOC_CAP_DEFAULT);
    uint8_t* c2 = (uint8_t*)heap_caps_malloc((sizeof(uint8_t) * (SEEDBYTES)), MALLOC_CAP_DEFAULT);
    poly cp;
    polyvecl mat[K], z;
    polyveck t1, w1, h;
