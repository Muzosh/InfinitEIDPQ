...
{
    size_t i;
    uint8_t* t = (uint8_t*)heap_caps_malloc((sizeof(uint8_t)*(200)), MALLOC_CAP_DEFAULT);
...
void shake128(uint8_t* output, size_t outlen, const uint8_t* input, size_t inlen)
{
    ...
    uint8_t* t = (uint8_t*)heap_caps_malloc((sizeof(uint8_t)*(SHAKE128_RATE)), MALLOC_CAP_DEFAULT);
    shake128ctx s;
...
void shake256(uint8_t* output, size_t outlen, const uint8_t* input, size_t inlen)
{
    ...
    uint8_t* t = (uint8_t*)heap_caps_malloc((sizeof(uint8_t)*(SHAKE256_RATE)), MALLOC_CAP_DEFAULT);
    shake256ctx s;
...
{
    uint8_t* t = (uint8_t*)heap_caps_malloc((sizeof(uint8_t)*(SHA3_256_RATE)), MALLOC_CAP_DEFAULT);
...
{
    uint64_t* s = (uint64_t*)heap_caps_malloc((sizeof(uint64_t)*(25)), MALLOC_CAP_DEFAULT);
    uint8_t* t = (uint8_t*)heap_caps_malloc((sizeof(uint8_t)*(SHA3_256_RATE)), MALLOC_CAP_DEFAULT);
...
{
    uint8_t* t = (uint8_t*)heap_caps_malloc((sizeof(uint8_t)*(SHA3_384_RATE)), MALLOC_CAP_DEFAULT);
...
{
    uint8_t* t = (uint8_t*)heap_caps_malloc((sizeof(uint8_t)*(SHA3_512_RATE)), MALLOC_CAP_DEFAULT);
